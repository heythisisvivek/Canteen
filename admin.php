...
<body>
    ...
    <div class="container">
      <a class="navbar-brand" href="http://localhost/Canteen/"><img src="images/siteImages/android-chrome-192x192.png" width="35" height="35" class="d-inline-block align-top" alt=""> Admin</a>
    ...
    <img class="mb-4" src="images/siteImages/chef.png" alt="" width="120" height="120">
    <h1 class="h3 mb-3 font-weight-normal">Admin Sign in</h1>
    <label for="inputEmail" class="sr-only">Email address</label>
    <input type="email" name="email" id="inputEmail" class="form-control" value="<?php if(isset($_SESSION["adminEmail"])) {echo $_SESSION["adminEmail"];} ?>" placeholder="Email address" required autofocus>
    ...
    <div class="checkbox mt-3">
        <label>
        <a href="adminsignup.php" style="color: #e23744">Sign Up</a>
        </label>
    </div>
    </form>
