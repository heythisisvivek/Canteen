...
<?php
  if(isset($_REQUEST["submit"])) {
    ...
    $country = inValidate($_REQUEST["country"]);
        ...
        $udpate = "UPDATE admin SET name = '$name', sname = '$sname', gender = '$gender', city = '$city', country = '$country' WHERE email = '$localEmail'";
  ...
  if(isset($_REQUEST['submitImage'])) {
    ...
    if(move_uploaded_file($_FILES['imageFile']['tmp_name'], $target_file)) {
      $insertImg = "UPDATE admin SET profilepic = '$target_file' WHERE email = '$localEmail'";
...
<body>
    ...
    <form style="margin: auto; text-align: center" action='<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>' method='post' enctype="multipart/form-data">
      ...
      <?php 
        $selTable = "SELECT * FROM admin WHERE email='$localEmail'";
